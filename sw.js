const CACHE_VERSION = "tao-shell-2026-08-21-v36-mobile-ux";
const SHELL = [
  "./",
  "./index.html",
  ...
  "./tao-components.css?v=1.0.1",
  "./tao-components.js?v=1.0.0",
  ...
  "./section-navigation.js?v=tao-ux-2",
  "./app-navigation.js?v=tao-ux-2",
  "./today-view.js?v=tao-ux-2",
  "./daily-tao-engine.mjs?v=2.3.0",
  "./seasonal-balance.mjs?v=1.0.2",
  "./daily-personal-signature.mjs",
  "./daily-cache.mjs?v=2.2.0",
  "./bazi-theme.js?v=tao-ux-2",
  "./profiles-view.js?v=tao-ux-2",
  ...
  "./yijing-view.js?v=tao-ux-2",
  "./pavilion-portals.js?v=tao-ux-2",
