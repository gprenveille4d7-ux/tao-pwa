const CACHE_VERSION = "tao-shell-2026-08-25-v43-mobile-copy-navigation";
const SHELL = [
  "./",
  "./index.html",
  ...
  "./product-experience.css?v=mobile-fixes-1",
  ...
  "./section-navigation.js?v=tao-ux-4",
  "./app-navigation.js?v=mobile-fixes-1",
  "./today-view.js?v=mobile-fixes-2",
