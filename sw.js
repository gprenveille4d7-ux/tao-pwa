...
const SHELL = [
  ...
  "./product-experience.css?v=tao-conversation-sheet-3",
  "./locales/index.js?v=1.5.0",
  "./locales/fr/index.js?v=1.5.0",
  "./locales/fr/profiles.js?v=constellation-2",
  ...
  "./family-number-engine.mjs?v=2.0.0",
  "./family-number-engine.mjs",
  "./family-pattern-engine.mjs?v=2.0.0",
  "./family-pattern-engine.mjs",
  "./family-rarity-engine.mjs?v=2.0.1",
  "./family-rarity-engine.mjs",
  "./family-rarity-client.js?v=2.0.1",
  "./family-rarity-worker.js?v=2.0.1",
  "./family-constellation-semantic.mjs?v=2.0.0",
  "./family-constellation-view.js?v=2.0.1",
