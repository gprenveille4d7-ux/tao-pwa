const CACHE_VERSION = "tao-shell-2026-08-20-v29-family-v4-daily-v2";
const SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=tao-environment-4",
  "./product-experience.css?v=tao-family-v4",
  "./locales/index.js?v=1.5.0",
  "./locales/fr/index.js?v=1.5.0",
  "./locales/fr/profiles.js?v=constellation-3",
  ...
  "./today-view.js?v=tao-daily-personal-1",
  "./daily-tao-engine.mjs?v=2.0.0",
  ...
  "./family-number-engine.mjs?v=3.0.0",
  ...
  "./family-constellation-view.js?v=4.0.0",
