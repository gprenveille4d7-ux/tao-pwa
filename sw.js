const CACHE_VERSION = "tao-shell-2026-08-13-v20-family";
const SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=tao-environment-4",
  "./product-experience.css?v=tao-family-4",
  "./locales/index.js?v=1.4.0",
  "./locales/fr/index.js?v=1.4.0",
  "./locales/fr/profiles.js?v=constellation-1",
  ...
  "./profiles-view.js?v=tao-family-4",
  "./relationships-view.js?v=1.0.4",
  "./relationship-engine.mjs",
  "./relationship-semantic.mjs?v=1.0.2",
  "./family-constellation-store.js",
  "./family-number-engine.mjs?v=1.0.1",
  "./family-constellation-semantic.mjs?v=1.0.1",
  "./family-constellation-view.js?v=1.0.3",
