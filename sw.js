const CACHE_VERSION = "tao-shell-2026-08-20-v32-family-inventory";
const SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=tao-environment-4",
  "./product-experience.css?v=tao-family-inventory-1",
  "./locales/index.js?v=1.5.1",
  "./locales/fr/index.js?v=1.5.1",
  ...
  "./family-constellation-view.js?v=4.1.0",
