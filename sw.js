const CACHE_VERSION = "tao-shell-2026-08-25-v44-navigation-complete";
const SHELL = [
  "./",
  "./index.html",
  ...
  "./styles.css?v=navigation-1",
  "./product-experience.css?v=navigation-1",
  "./tao-components.css?v=navigation-2",
  "./tao-components.js?v=navigation-2",
  ...
  "./tao-ai-conversation.js?v=navigation-2",
  "./navigation-routes.mjs?v=tao-ux-3",
  "./section-navigation.js?v=tao-ux-5",
  "./app-navigation.js?v=navigation-3",
  "./today-view.js?v=navigation-3",
  "./daily-tao-engine.mjs?v=2.3.1",
  "./seasonal-balance.mjs?v=1.2.0",
  "./seasonal-knowledge.mjs?v=1.0.0",
  "./seasonal-library.js?v=navigation-2",
  "./daily-personal-signature.mjs",
  "./daily-cache.mjs?v=2.3.1",
  "./bazi-theme.js?v=navigation-3",
  "./day-master-archetypes.mjs?v=1.0.1",
  "./profiles-view.js?v=navigation-3",
  "./onboarding.js?v=navigation-1",
  "./profile-store.js",
  "./relationships-view.js?v=navigation-3",
  ...
  "./family-constellation-view.js?v=navigation-3",
  "./family-constellation-lexicon.mjs?v=1.0.0",
  "./yijing-view.js?v=navigation-2",
  "./pavilion-portals.js?v=navigation-2",
