const CACHE_VERSION = "tao-shell-2026-08-24-v37-clarity-celestial-dayun";
const SHELL = [
  "./",
  "./index.html",
  ...
  "./tao-components.css?v=clarity-1",
  ...
  "./environment-controller.js?v=clarity-1",
